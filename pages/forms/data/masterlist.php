...
while ($displayPerDept = mysqli_fetch_array($deptAll)) {
    ...
    where ay_id = '$_SESSION[AC]' and tbl_courses.department_id='$displayPerDept[department_id]' and sem_id = '$_SESSION[S]' and remark= 'Approved' ORDER BY tbl_courses.course, tbl_schoolyears.year_id, lastname") or die(mysqli_error($db));
