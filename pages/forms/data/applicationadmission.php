...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(35, 3, 'april 20 2023', 'B', 0, 'L'); // for data
$pdf->Cell(65, 4, '', 0, 0,); // spacing
$pdf->Cell(32, 3, 'ACADEMIC YEAR ', 0, 0);
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(26, 3, $_SESSION['AC'], 'B', 1, 'L'); // for data
...
$pdf->Rect(10, 81, 5, 4,  ($row['course_id'] == 2) ? true : false);// box
$pdf->Cell(8, 5, '', 0, 0,); // spacing
...
$pdf->Rect(10, 86, 5, 4,  ($row['course_id'] == 3) ? true : false);// box
$pdf->Cell(8, 5, '', 0, 0,); // spacing
