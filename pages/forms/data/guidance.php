...
$student_info = mysqli_query($conn, "SELECT *, CONCAT(student_lname, ', ', student_fname, ' ', student_mname) AS fullname 
FROM tbl_students 
...
WHERE remark = 'Approved' AND ay_id = '$ay_id' AND tbl_students.student_id = '$stud_id'");
...
$pdf->Image('../../../assets/img/logo.png', 45, 8, 15, 15);
// text color
...
$pdf->Cell(40, 3, $row['lrn'],'B', 0); // FOR DATA 
...
$pdf->Cell(35, 3, $row['date_ap'],'B', 1); // FOR DATA 
...
$pdf->Cell(20, 4, $row['student_lname'], 0, 0); //data
$pdf->Cell(48, 4, '', 0, 0);// space
$pdf->Cell(45, 4, $row['student_fname'], 0, 0); // data
$pdf->Cell(20, 4, '', 0, 0);// space
$pdf->Cell(45, 4, $row['student_mname'], 0, 1); // data
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 4, '', 0, 0); // space
$pdf->Cell(28, 5, $row['address'], 0, 1); // data sige
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 4, '', 0, 0); // space
$pdf->Cell(28, 4, $row['address'], 0, 1); // data sige lang
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, $row['date_birth'], 0, 0); // date of birth
$pdf->Cell(8, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, $row['place_birth'], 0, 0);// place birth
$pdf->Cell(9, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, $row['gender_name'], 0, 0);//  sex
$pdf->Cell(10, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, '', 0, 0); //  civil
$pdf->Cell(7, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, '', 0, 1);//  height
...
$pdf->Cell(8, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, $row['cellphone'], 0, 0);// number
$pdf->Cell(9, 4, '', 0, 0); // space 
$pdf->Cell(28, 4, $row['landline'], 0, 0);//  Telephone
$pdf->Cell(10, 4, '', 0, 0); // space lang
$pdf->Cell(28, 4, $row['email'], 0, 1); //  Email
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 4, $row['fname'], 0, 0); // name
$pdf->Cell(30, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 4, $row['focc'], 0, 0); // occu
$pdf->Cell(30, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 4, $row['fcontact'], 0, 1); // num
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 3, $row['mname'], 0, 0); // name
$pdf->Cell(30, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 3, $row['mocc'], 0, 0); // occu
$pdf->Cell(30, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 3, $row['mcontact'], 0, 1); // num
...
$pdf->Cell(45, 5, 'Name', 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, 'Occupation', 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, 'Contact', 0, 1);// data
//////////////////////////   data boi sige lang
$pdf->SetFont('Arial', '', 9);
$pdf->Ln(1);
$pdf->Cell(25, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib1_name'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib1_age'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, $row['sib1_civ'], 0, 1);// data
$pdf->Ln(1);
$pdf->Cell(25, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib2_name'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib2_age'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, $row['sib2_civ'], 0, 1);// data
$pdf->Ln(1);
$pdf->Cell(25, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib3_name'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib3_age'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, $row['sib3_civ'], 0, 1);// data
$pdf->Ln(1);
$pdf->Cell(25, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib4_name'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, $row['sib4_name'], 0, 0);// data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, $row['sib4_civ'], 0, 1);// data
